...
(function($) {
  ...
  sendButton.addEventListener('click', async (e) => {
    ...
    const data = await Email.send({
      Host: "smtp.gmail.com",
      Username: 'archilhirapra0513@gmail.com',
      Password: "Raj##0513",
      To: 'archilhirapra0513@gmail.com',
      From: emailId,
      Subject: name,
      Body: emailTextArea,
  ...
  //   secure: false,
  //   auth: {
  //     user: 'archilhirapra0513@gmail.com',
  //     pass: 'Raj##0513'
  //   }
  // });
  ...
  //   const mailOptions = {
  //     from: name,
  //     to: 'archilhirapra1920@gmail.com',
  //     subject: 'Hello',
  //     text: 'This is a test email from Nodemailer.'
  //   };
